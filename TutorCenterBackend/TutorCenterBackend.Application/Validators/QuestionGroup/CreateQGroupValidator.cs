...
{
    public class CreateQGroupValidator : AbstractValidator<CreateQGroupRequestDto>
    {
        public CreateQGroupValidator()
        {
            RuleFor(x => x.QuizId)
                .GreaterThan(0).WithMessage("Id bài kiểm tra phải lớn hơn 0.");
