...
namespace api_backend.Repositories.Abstracts
{
    public interface IJoinRequestRepository : IBaseRepository<JoinRequest>
    {
        ...
        Task<JoinRequest?> GetExistingRequestAsync(int classroomId, int studentId, CancellationToken ct = default);
        ...
        Task RemoveJoinRequestAsync(int classroomId, int studentId, CancellationToken ct = default);
    }
}
