          ...
          <div className="lg:col-span-3">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                  <div className="flex items-center gap-6">
                    <div className="relative">
                      <div className="w-24 h-24 bg-gradient-to-br from-purple-500 to-purple-700 rounded-full flex items-center justify-center text-white text-3xl font-semibold font-poppins">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-purple-600 font-semibold font-open-sans mt-1">
                        Giáo viên
                      </p>
                    </div>
                    {!isEditing && (
            ...
            {activeTab === 'notifications' && (
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-4">
                  {[
                    { label: 'Thông báo học sinh mới', description: 'Nhận thông báo khi có học sinh đăng ký lớp' },
                    { label: 'Thông báo bài tập được nộp', description: 'Nhận thông báo khi học sinh nộp bài tập' },
                    { label: 'Thông báo câu hỏi mới', description: 'Nhận thông báo khi học sinh đặt câu hỏi' },
