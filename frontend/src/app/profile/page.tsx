...
export default function ProfilePage() {
  ...
  // Lấy userRole cho Header
  const getUserRole = (): 'admin' | 'tutor' | 'student' => {
    if (!profile?.role) return 'student';
    const role = profile.role.toLowerCase();
    if (role === 'admin' || role === 'teacher') return role as 'admin' | 'tutor';
    return 'student';
  };

  // Render Stats Tab dựa trên role
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-purple-50 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-sm text-gray-600">Bài tập đã giao</p>
                </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { label: 'Thông báo bài tập', description: 'Nhận thông báo khi có bài tập mới hoặc được chấm điểm' },
                    ...
                    { label: 'Thông báo hệ thống', description: 'Nhận thông báo về hoạt động và cập nhật hệ thống' }
                  ].map((item, index) => (
