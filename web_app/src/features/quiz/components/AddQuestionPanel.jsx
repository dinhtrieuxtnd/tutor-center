...
export const AddQuestionPanel = ({ isOpen, onClose, onSubmit, isLoading, quizId, sectionId, groupId }) => {
    ...
    const handleClose = () => {
        setFormData({ content: '', explanation: '', questionType: 0, points: 1, orderIndex: 0 });
        setErrors({});
        onClose();
    };
        ...
        <>
            ...
            <div className="fixed right-0 top-0 h-screen w-[600px] bg-primary shadow-lg z-50 flex flex-col">
                <div className="flex items-center justify-between p-4 border-b border-border">
                    <h2 className="text-lg font-semibold text-foreground">Thêm câu hỏi mới</h2>
