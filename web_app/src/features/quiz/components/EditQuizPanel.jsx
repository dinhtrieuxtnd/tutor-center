...
export const EditQuizPanel = ({ isOpen, onClose, onSubmit, isLoading, quiz }) => {
  ...
  useEffect(() => {
    if (quiz && isOpen) {
      setFormData({
        ...
        shuffleOptions: quiz.shuffleOptions !== undefined ? quiz.shuffleOptions : true,
      });
    }
  }, [quiz, isOpen]);
    ...
    <>
      ...
      <div className="fixed right-0 top-0 h-screen w-[600px] bg-primary shadow-lg z-50 flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 border-b border-border flex-shrink-0">
          <h2 className="text-lg font-semibold text-foreground">Chỉnh sửa bài kiểm tra</h2>
          <button
            onClick={handleClose}
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 min-h-0">
            ...
            <div className="border-t border-border pt-4">
              <p className="text-xs text-foreground-light">
                <strong>Lưu ý:</strong> Để quản lý câu hỏi, vui lòng sử dụng chức năng xem chi tiết quiz.
              </p>
            </div>
          </div>
