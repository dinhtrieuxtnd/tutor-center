...
export const AddLecturePanel = ({ isOpen, onClose, onSubmit, isLoading }) => {
    ...
    <>
      ...
      <div className="fixed right-0 top-0 h-screen w-[500px] bg-primary shadow-lg z-50 flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 border-b border-border flex-shrink-0">
          <h2 className="text-lg font-semibold text-foreground">Thêm bài giảng mới</h2>
          <button
            onClick={handleClose}
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 min-h-0">
            ...
            <div className="border-t border-border pt-4 mt-4">
              <p className="text-xs text-foreground-light mb-2">
                <strong>Lưu ý:</strong> Bạn có thể tạo bài giảng con sau khi tạo bài giảng gốc.
              </p>
            </div>
          </div>
